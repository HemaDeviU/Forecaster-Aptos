...
const BottomMenu = () => {
  return (
    <nav className='relative p-8 pt-1.5 pb-0'>
        ...
        <div className="container mx-auto flex justify-between items-center px-4 rounded-full z-10 relative">
            ...
            <Link href="/" className="menu-icon-box flex flex-col items-center w-[50px] pb-6 gap-1">
                <div className='bg-accent border-8 rounded-full w-[76px] h-[76px] flex justify-center items-center' style={{ borderColor: '#552C94' }}>
